...
from BATCOMPUTER.load_llm import load_model
from BATCOMPUTER.prompts.prompt import conversation_prompt
from BATCOMPUTER.utils import get_username, magic_commands, read_file

try:
    import readline
except:
    pass
from BATCOMPUTER.settings.config import (
    DEVICE_TYPE,
    MODEL_FILE,
    MODEL_NAME,
    MODEL_TYPE,
